...
public class Order2 {
    ...
    private List<RefundFlowingsBean> RefundFlowings;
    ...
    public List<RefundFlowingsBean> getRefundFlowings() {
        return RefundFlowings;
    }

    public void setRefundFlowings(List<RefundFlowingsBean> RefundFlowings) {
    ...
    public static class RefundFlowingsBean {
