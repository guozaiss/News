...
public abstract class DePinnedHeaderAdapter<T> extends CompositeAdapter<T> {
    ...
    public DePinnedHeaderAdapter(Context context) {
        super(context);

    }

    public DePinnedHeaderAdapter(Context context, Collection<List<T>> collection) {
        super(context);
...
//FIXME true
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (view instanceof DePinnedHeaderListView) {
            ((DePinnedHeaderListView) view).configureHeaderView(firstVisibleItem);
        }
    }
