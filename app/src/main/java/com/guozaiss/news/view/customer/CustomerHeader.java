package com.guozaiss.news.view.customer;
...
/**
 * Created by guozaiss on 16/6/18.
 */
public class CustomerHeader extends FrameLayout implements PtrUIHandler {
    ...
    private ImageView ptr_classic_header_rotate_view_imageView;
    private AnimationDrawable drawable;
    private boolean drawableStart = false;
    ...
    public CustomerHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public CustomerHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.head, this);
        ...
        ptr_classic_header_rotate_view_imageView = (ImageView) header.findViewById(R.id.ptr_classic_header_rotate_view_imageView);
    ...
    private void Anim(int VISIABLE) {
        if (drawable == null) {
            drawable = (AnimationDrawable) ptr_classic_header_rotate_view_imageView.getDrawable();
        }
        if (VISIABLE == View.VISIBLE) {
            ...
            ptr_classic_header_rotate_view_imageView.setVisibility(VISIBLE);
        } else {
            if (drawableStart) {
                drawable.stop();
                drawableStart = !drawableStart;
            }
            ptr_classic_header_rotate_view_imageView.setVisibility(INVISIBLE);
        }
    }
